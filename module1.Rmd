...
1. This is a take-home test, but you are welcome to attend class, and I will do my best to facilitate (but not provide answers). Work on it wherever you are most comfortable and discuss as needed but please do the writing independently because of the plagarism check tool associated with turnitin.   
2. You must submit the test as a **PDF** to [turnitin.com](http://www.turnitin.com) by midnight the following day after class.  
3. The test is worth 40%, and the grading will be one point per percent.  
4. Font must be sized at least 11 point, 1 inch margins, and writing must also adhere to the following guidelines.  Memory: NO more than 2 pages total, Concepts: no more than two pages (1 page for each question), Synthesis: no more than 2 pages for the single question. Summary - two pages for each section no exceptions.  
5. Memory worth 10%, concepts worth 10%, and synthesis worth 20%. 
6. From memory select ONLY 5 questions from 1,2,3,5,6,8; from concepts select ONLY 2 questions from 1,4,5; and synthesis select only 1 question from 1 or 3.  
7. A sketch is required for either synthesis question you choose but do not count towards page limit.  You can draw by hand and scan or use powerpoint or keynote to make your visual. It can be included as a third and separate page if it makes it easier to see it.  
8. The purpose of the sketch is to leverage all the hard work you did in labs - so sketches should be a mechanism to enhance your explanation, and the marking key includes that recognition.  
9. No citations needed - I trust ya.  
10. I strongly prefer double-spaced, but if you need to write more and must adhere to the page limits, feel free to switch to 1.5 or single-spaced as needed.  
11. Please ensure the PDF is entitled 'Surname_test.PDF' and that your name and student ID is at the top of the first page of test.  
